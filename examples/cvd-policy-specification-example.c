...
/**
 * Example 4: Policy override behavior
 */
void example_policy_override_explanation(void)
{
    printf("=== Example 4: Policy Override Behavior ===\n\n");
    
    printf("CVD Security Policy Resolution:\n");
    printf("1. Per-container policy (highest priority)\n");
    printf("   - Specified in params.policy.profiles\n");
    printf("   - Overrides global configuration\n");
    printf("   - Custom paths from config are NOT applied\n\n");
    
    printf("2. Global default policy (from cvd.json)\n");
    printf("   - Used when params.policy.profiles is NULL or empty\n");
    printf("   - Includes custom_paths from configuration\n");
    printf("   - Set via 'security.default_policy' in cvd.json\n\n");
    
    printf("3. Hardcoded minimal (fallback)\n");
    printf("   - Used if no configuration exists\n");
    printf("   - Basic CLI application support only\n\n");
...
{
    printf("CVD Per-Container Policy Examples\n");
    printf("==================================\n\n");
    ...
    // Show policy override explanation
    ...
    printf("=== Summary ===\n");
    printf("Per-container policies allow fine-grained control over container\n");
    printf("security without changing the CVD configuration file.\n\n");
    
    printf("Available policy types:\n");
    printf("  - minimal:  Basic CLI applications\n");
    printf("  - build:    Compilation and build tools\n");
    printf("  - network:  Network services and clients\n");
    printf("  - custom:   Start with no permissions\n\n");
