...
#
get_filename_component(filename "/home/runner/work/bake/bake/_codeql_build_dir/bundled_zstd-prefix/src/v1.5.7.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/bake/bake/_codeql_build_dir/bundled_zstd-prefix/src/bundled_zstd" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-bundled_zstd${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-bundled_zstd${i}")
