...
#
get_filename_component(filename "/home/runner/work/bake/bake/_codeql_build_dir/lua54-prefix/src/lua-5.4.7.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/bake/bake/_codeql_build_dir/lua54-prefix/src/lua54" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-lua54${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-lua54${i}")
