...
#
get_filename_component(filename "/home/runner/work/bake/bake/_codeql_build_dir/bundled_jansson-prefix/src/v2.14.1.tar.gz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/bake/bake/_codeql_build_dir/bundled_jansson-prefix/src/bundled_jansson" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-bundled_jansson${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-bundled_jansson${i}")
