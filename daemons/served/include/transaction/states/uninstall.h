...
#ifndef __SERVED_TRANSACTION_STATE_UNINSTALL_H__
#define __SERVED_TRANSACTION_STATE_UNINSTALL_H__

#include "../sm.h"
#include "types.h"

extern enum sm_action_result served_handle_state_uninstall(void* context);
...
#endif //!__SERVED_TRANSACTION_STATE_UNINSTALL_H__
