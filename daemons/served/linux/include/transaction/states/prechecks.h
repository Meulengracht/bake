...
#ifndef __SERVED_TRANSACTION_STATE_PRECHECK_H__
#define __SERVED_TRANSACTION_STATE_PRECHECK_H__

#include "../sm.h"
#include "types.h"

extern enum sm_action_result served_handle_state_precheck(void* context);
