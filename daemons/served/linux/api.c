...
void chef_served_install_invocation(struct gracht_message* message, const char* packageName)
{
...
void chef_served_update_invocation(struct gracht_message* message, const char* packageName)
{

}

void chef_served_update_all_invocation(struct gracht_message* message)
{
